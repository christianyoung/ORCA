...
def create_widgets_in_first_frame():
    ...
    disclaimer ="""Organizational Relationship Contact Analyzer \n
...
def create_widgets_in_select_gangfac_frame(Options,Options2):
    ...
    if Options2 ==[]:
        ...
        pdfButton = Button(textFrame, text = "View Full PDF", command = lambda: viewPDF(Options[PrintableNames.index(selection.get())]), width = 20)
    ...
    if Options ==[]:
        ...
        pdfButton = Button(textFrame, text = "View Full PDF", command = lambda: viewPDF(Options2[PrintableNames.index(selection.get())]), width = 20)
        tacpdfButton=Button(textFrame,text = "View Tactical PDF",command=lambda:tacPDF(Options2[PrintableNames.index(selection.get())]),width = 20)
